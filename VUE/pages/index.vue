...
export default {
  ...
  mounted() {
    //esto es lo primero que se dispara al momento de cargar el componente
    //se le pasa por parametros la ruta del dominio donde se le va enviar las variables
    ...
    //UNA VEZ REALIZADO LA CONEXION CON EL DOMINIO, SE PROCESE A REALIZAR LAS PETICIONES SET, GET O REMOVE

    //A CONTINUACION INDICO UNOS EJEMPLOS

    //CREAR
    cdstorage.setItem(
      "a_cross-domain_key3000",
      "El valor debe ser una cadena o se convertirá en una cadena..."
    );

    //OBTENER
    cdstorage.getItem("otra_variebla_vue", function(key, value) {
      console.info("<br/>Cross Domain callback: (" + key + ": " + value + ")");
    });
    //ELIMINAR
    cdstorage.removeItem("a_cross-domain_key3000");
  }
};
</script>
